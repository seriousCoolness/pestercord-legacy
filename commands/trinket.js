...
exports.desc = "Interact with equipped trinket"
exports.use = `">trinket" will display the currently equipped trinket, if there is one.
">trinket equip [number]" will equip the number item in your sylladex if it's a trinket.
">trinket eject" will drop your currently equipped trinket in your current room.`
